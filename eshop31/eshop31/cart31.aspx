<%@ Page Title="" Language="C#" MasterPageFile="~/shop.Master" AutoEventWireup="true" CodeBehind="cart31.aspx.cs" Inherits="eshop31.car31" %>
                ...
                <ItemTemplate>
                    <div class="cart_item_frame">
                        ...
                        <div class="product_frame">
                            <asp:HyperLink ID="hl_productname" runat="server" NavigateUrl='<%# Eval("MerId", "detail31.aspx?id={0}") %>'
