<%@ Page Title="" Language="C#" MasterPageFile="~/shop.Master" AutoEventWireup="true" CodeBehind="order31.aspx.cs" Inherits="eshop31.order31" %>
            ...
            <div class="order_item">
                ...
                <div style="font-size: small; float: left; width: auto; margin: 5px 0 5px 10px;">
                    <asp:LinkButton ID="lnk_address" runat="server" 
                        PostBackUrl="~/myhome/myaddress31.aspx" onclick="lnk_address_Click">[添加地址]</asp:LinkButton>
                </div>
