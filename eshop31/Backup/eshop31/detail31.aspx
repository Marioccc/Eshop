<%@ Page Title="" Language="C#" MasterPageFile="~/shop.Master" AutoEventWireup="true" CodeBehind="detail31.aspx.cs" Inherits="eshop31.detail31" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="text-align: left">
        ...
        <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/cart31.aspx" 
            onclick="LinkButton1_Click">查看购物车</asp:LinkButton>
        <br />
