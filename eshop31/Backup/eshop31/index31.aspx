<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="index31.aspx.cs" Inherits="eshop31.index31" %>
                ...
                <div class="prod_box">
                    ...
                    <div class="center_prod_box">
                        <div class="product_title">
                            <a href="detail31.aspx">
                                <%#Eval("MerName") %></a></div>
                        <div class="product_img">
                            <a href='<%# Eval("MerId","detail31.aspx?id={0}") %>'>
                                <asp:Image ID="Image1" runat="server" Height="75px" ImageUrl='<%# Eval("Picture") %>'
                                    Width="113px" /></a>
                        </div>
                        <div class="prod_price">
                            <span class="reduce">'<%# Eval("price") %>'/span> <span class="price">'<%# Eval("sprice") %>'</span></div>
                    </div>
                    <div class="bottom_prod_box">
                    </div>
                    <div class="prod_details_tab">
                        <a href='<%# Eval("MerId","detail31.aspx?id={0}") %>' title="header=[Add to cart] body=[&nbsp;] fade=[on]">
                            <img alt="" border="0" class="left_bt" src="image/cart.gif" title="" /></a>
                        <a class="prod_details" href='<%# Eval("MerId","detail31.aspx?id={0}") %>'>details</a>
                    </div>
                </div>
            </ItemTemplate>
        </asp:DataList>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eshopConnectionString %>"
            SelectCommand="SELECT TOP 6 MerId, category, MerName, Price, SPrice, Picture, GoodDesc, GoodFacturer, LeaveFactoryDate, Special, inputdate, bengindate, enddate FROM merchandisc ORDER BY inputdate DESC">
        </asp:SqlDataSource>
        <!-- end of 商品速递 -->
        <div class="center_title_bar">
            <div class="center_title_left">
                ...
                <div class="prod_box">
                    ...
                    <div class="center_prod_box">
                       ...
                       <a href = '<%# Eval("MerId","detail31.aspx?id={0}") %>'>
                        ...
                        <div class="prod_price">
                            <span class="reduce">￥<%# Eval("price") %>￥<%# Eval("sprice") %></span></div>
                    </div>
                    <div class="bottom_prod_box">
                    </div>
                    <div class="prod_details_tab">
