<%@ Page Title="" Language="C#" MasterPageFile="~/shop.Master" AutoEventWireup="true" CodeBehind="login31.aspx.cs" Inherits="eshop31.login31" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class=" login_frame">
        <div class="form_row ">
            ...
            <asp:TextBox ID="txtAccount" runat="server" CssClass="rightInput">guest</asp:TextBox>
        </div>
        <div class="form_row ">
            <asp:Label ID="lblPassword" runat="server" Text="密　码：" CssClass="leftlabel"></asp:Label>
            <asp:TextBox ID="txtPassword" runat="server" CssClass="rightInput" TextMode="Password">123456</asp:TextBox>
        </div>
        <div class="form_row " title="用户登录">
            ...
            <img alt="" src="checkcode31.aspx" style="float: left" />
        </div>
        <div class="form_row ">
            ...
            <asp:Button ID="btnReg" runat="server" Text="立即注册" CssClass="loginbtn" 
                onclick="btnReg_Click" Height="27px" Width="93px" />
        </div>
    </div>
    </div>
</asp:Content>
