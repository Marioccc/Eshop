<%@ Page Title="" Language="C#" MasterPageFile="~/shop.Master" AutoEventWireup="true" CodeBehind="product.aspx.cs" Inherits="eshop201702845.product" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <div style="text-align: left; padding :15px">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        Width="100%" AllowPaging="True" PageSize="5" EnableModelValidation="True">
        <Columns>
            <asp:ImageField DataImageUrlField="Picture" HeaderText="图片">
                <ControlStyle Width="100px" />
            </asp:ImageField>
            <asp:HyperLinkField DataNavigateUrlFields="MerId" 
                DataNavigateUrlFormatString="detail31.aspx?id={0}" DataTextField="MerName" 
                HeaderText="商品名称" />
            <asp:BoundField DataField="Price" DataFormatString="{0:C}" HeaderText="商品价格" 
                SortExpression="Price" />
            <asp:BoundField DataField="SPrice" DataFormatString="{0:C}" HeaderText="E价格" 
