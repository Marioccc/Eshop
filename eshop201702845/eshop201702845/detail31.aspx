<%@ Page Title="" Language="C#" MasterPageFile="~/shop.Master" AutoEventWireup="true" CodeBehind="detail31.aspx.cs" Inherits="eshop201702845.detail31" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eshopConnectionString %>"
    ...
    <div style="text-align: left">
        ...
        <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/Cart31.aspx">查看购物车</asp:LinkButton>
        <br />
