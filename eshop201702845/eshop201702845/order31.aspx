<%@ Page Title="" Language="C#" MasterPageFile="~/shop.Master" AutoEventWireup="true" CodeBehind="order31.aspx.cs" Inherits="eshop201702845.order" %>
...
<div id="order_main">
            ...
            <div class="order_item">
                ...
                <div style="font-size: small; float: left; width: auto; margin: 5px 0 5px 10px;">
                    <asp:LinkButton ID="lnk_address" runat="server" 
                        PostBackUrl="~/myhome/myalloeder31.aspx" onclick="lnk_address_Click">[添加地址]</asp:LinkButton>
                </div>
        ...
        <div class="order_content ">
           ...
           <asp:Button ID="Button1" runat="server" Text="生成订单" CssClass="btn" 
                    onclick="Button1_Click" Height="37px" Width="93px" /> </div>
