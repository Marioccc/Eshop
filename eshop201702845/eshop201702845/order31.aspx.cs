    ...
    public partial class order : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                RadioButtonList1.Selectedindex31 = 0;
            }
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (DbManager.ExceSQL(strsql))
            {
                ...
                Response.Write("<script> alert('订单生成');window.location.href='myhome/myalloeder31.aspx'</script>");
            }
        }

        protected void lnk_address_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/myhome/myaddress.aspx");
        }
    }
}