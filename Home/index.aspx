                ...
                <div class="col-md-3 shopping-color">
                    <div class="row row-center">
                        <div class="text-center shop-margin-top">
                            ...
                            <p class="padding-top-bottom">剩余时间</p>
                            <p class="left-time">
                                <span>00</span>
                                <span>:</span>
                                <span>00</span>
    ...
    <section class="bg-light phone">
        <div class="container clearPadding">
            ...
            <div class="row shop-card">
                <div class="col-md-2">
                    <img class="img-fluid"
                        src="//cdn.cnbj1.fds.api.mi-img.com/mi-mall/574c6643ab91c6618bfb2d0e2c761d0b.jpg?thumb=1&w=293&h=768&f=webp&q=90"
                        alt="">
                </div>
                <div class="col-md-2 phone-col-margin">
                    <div class="row">
                        <div class="row shop-card">
                            <a href="#">
                                <div class="card">
                    ...
                    <div class="row phone-row-margin">
                        <div class="row shop-card">
                            <a href="#">
                                <div class="card">
                                    <img src="./images/08e0d3e4-63a8-3de4-107a-f6977321f106.jpg" class="card-img-top"
